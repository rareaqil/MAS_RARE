...
<body class="g-sidenav-hidden  bg-gray-200">
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="#" target="_blank">
                <img src="assets/img/logo_putih.png" class="navbar-brand-img h-200" alt="main_logo">
                <span class="ms-1 font-weight-bold text-white">MAS RARE</span>
            </a>
        </div>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <head>
            ...
            <div style="background-image: url('assets/img/logo_hitam.png');   height: 500px; 
                background-position: center; background-repeat: no-repeat;   background-size: contain,cover; "></div>
            {{-- <img style=" height: 500px; text-align:center; " src="assets/img/logo_hitam.png" alt=""> --}}
            <br>
            <h2 align="center">
                Performance <br>
                <?php
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a
                                                ...
                                                120.0000
                                                @else --}}
                                                {{ number_format($data ['CNOP_AVAIL_VALUE'], 4, '.', ',') }}
                                                {{-- @endif --}}
                                                %
                                            </a></td>
                                        <td><a
